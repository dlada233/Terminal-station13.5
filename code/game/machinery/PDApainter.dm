...
/obj/machinery/pdapainter
	name = "\improper 平板&ID打印机"
	desc = "将PDA或者ID插入然后选择对应的模板就可以在上面打印图案了."

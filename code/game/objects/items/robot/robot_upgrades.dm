...
/obj/item/borg/upgrade/ai
	name = "B.O.R.I.S. 模块"
	desc = "用蓝空技术优化的远程智能同步模块，它取代cyborg体内MMI的位置，创造了一个由AI核心控制的cyborg."
	icon_state = "boris"

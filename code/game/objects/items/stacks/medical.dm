...
/obj/item/stack/medical/gauze
	name = "医用纱布"
	desc = "一卷弹性纱布，非常适合稳定各种伤口，从创伤、烧伤到骨折."
	gender = PLURAL
	singular_name = "医用纱布"
	icon_state = "gauze"
...
/obj/item/stack/medical/suture/emergency
	name = "应急缝针"
	desc = "应急的无菌缝合针，用于缝上伤口止血以及治疗创伤，但治疗效果稍微差一些."
	heal_brute = 5
	amount = 5
	max_amount = 5
...
/obj/item/stack/medical/ointment
	name = "药膏"
	desc = "基本的烧伤药膏，在包扎得当的情况下对二度烧伤有效，对更严重的烧伤仍然是有效的稳定剂，但不太擅长彻底治愈烧伤."
	gender = PLURAL
	singular_name = "药膏"
	icon_state = "ointment"
	lefthand_file = 'icons/mob/inhands/equipment/medical_lefthand.dmi'
...
/obj/item/stack/medical/mesh/advanced
	name = "高级再生网格"
	desc = "一种用芦荟提取物和消毒化学品制成的高级再生网格，用于治疗烧伤."
...
/obj/item/stack/medical/bone_gel
	name = "骨胶"
	singular_name = "骨胶"
	desc = "一种强效的医用凝胶，在适当的外科手术环境下涂在受损的骨头上，引发强烈的融合反应以修复骨裂，在严重的情况下，可以与手术胶带一起直接应用于骨折伤口上，尽管这对患者非常有害."
...
/obj/item/stack/medical/poultice
	name = "丧事膏"
	singular_name = "丧事膏"
	desc = "原始的草药膏.\n传统上是给丧礼死者使用的，但特殊情况下也可以治疗活人身上的创伤和烧伤，只是可能引起呼吸短促.\n它凝聚了古人的智慧."
	icon_state = "poultice"
	amount = 15
	max_amount = 15
	heal_brute = 10

...
/obj/item/stack/sheet/mineral/plasma
	name = "solid plasma-固态等离子"
	icon_state = "sheet-plasma"
	inhand_icon_state = "sheet-plasma"
	singular_name = "plasma sheet-固态等离子"
	sheettype = "plasma"
...
GLOBAL_LIST_INIT(gold_recipes, list ( \
	...
	new/datum/stack_recipe("空白匾牌", /obj/item/plaque, 1, check_density = FALSE, category = CAT_FURNITURE), \
	new/datum/stack_recipe("简单王冠", /obj/item/clothing/head/costume/crown, 5, check_density = FALSE, category = CAT_CLOTHING), \
	))
...
/obj/item/stack/sheet/mineral/titanium
	...
	singular_name = "titanium sheet-钛"
	force = 5
	throwforce = 5
...
/obj/item/stack/sheet/mineral/plastitanium
	name = "plastitanium-塑钢"
	icon_state = "sheet-plastitanium"
	inhand_icon_state = "sheet-plastitanium"
	singular_name = "plastitanium sheet-塑钢"
	force = 5
	throwforce = 5
	w_class = WEIGHT_CLASS_NORMAL
	throw_speed = 1
...
GLOBAL_LIST_INIT(adamantine_recipes, list(
	new /datum/stack_recipe("不完整的仆从傀儡壳", /obj/item/golem_shell/servant, req_amount=1, res_amount=1, category = CAT_ROBOT),
	))
...
/obj/item/stack/sheet/mineral/adamantine
	...
	singular_name = "adamantine sheet-精金"

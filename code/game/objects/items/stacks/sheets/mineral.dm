...
/obj/item/stack/sheet/mineral/plasma/suicide_act(mob/living/carbon/user)
	user.visible_message(span_suicide("[user] begins licking \the [src]! 看起来是在尝试自杀!"))
...
GLOBAL_LIST_INIT(gold_recipes, list ( \
	new/datum/stack_recipe("golden door-黄金门", /obj/structure/mineral_door/gold, 10, time = 5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND | CRAFT_APPLIES_MATS, category = CAT_DOORS), \
	new/datum/stack_recipe("gold tile-黄金地砖", /obj/item/stack/tile/mineral/gold, 1, 4, 20, crafting_flags = NONE, category = CAT_TILES), \
	new/datum/stack_recipe("blank plaque-空白匾牌", /obj/item/plaque, 1, crafting_flags = NONE, category = CAT_FURNITURE), \
	new/datum/stack_recipe("Simple Crown-简易王冠", /obj/item/clothing/head/costume/crown, 5, crafting_flags = NONE, category = CAT_CLOTHING), \
	))
...
GLOBAL_LIST_INIT(adamantine_recipes, list(
	new /datum/stack_recipe("incomplete servant golem shell-不完整的仆从石人躯壳", /obj/item/golem_shell/servant, req_amount=1, res_amount=1, category = CAT_ROBOT),
	))
...
GLOBAL_LIST_INIT(metalhydrogen_recipes, list(
	...
	new /datum/stack_recipe("metallic hydrogen-氢气 axe", /obj/item/fireaxe/metal_h2_axe, req_amount = 15, res_amount = 1, crafting_flags = NONE, category = CAT_WEAPON_MELEE),
	new /datum/stack_recipe("metallic hydrogen-氢气 bolts", /obj/item/ammo_casing/rebar/hydrogen, req_amount = 1, res_amount = 1, crafting_flags = NONE, category = CAT_WEAPON_AMMO),
	))

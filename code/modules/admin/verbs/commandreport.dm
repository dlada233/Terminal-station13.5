...
#define CENTCOM_PRESET "中央指挥部"
#define SYNDICATE_PRESET "辛迪加联盟"
#define WIZARD_PRESET "巫师联盟"
#define CUSTOM_PRESET "Custom Command Name"

ADMIN_VERB(change_command_name, R_ADMIN, "改变指挥部名称", "Change the name of Central Command.", ADMIN_CATEGORY_EVENTS)
...
ADMIN_VERB(create_command_report, R_ADMIN, "创建命令书", "Create a command report to be sent to the station.", ADMIN_CATEGORY_EVENTS)

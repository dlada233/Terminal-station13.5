/datum/action/cooldown/spell/pointed/projectile/moon_parade
	...
	active_msg = "你准备让他们加入游行队伍！"
	deactive_msg = "你暂时停止了音乐，停止了游行."
	cast_range = 12
...
/obj/projectile/moon_parade/prehit_pierce(atom/A)
	...
	if(victim.can_block_magic(MAGIC_RESISTANCE))
		visible_message(span_warning("游行击中了[victim]，但一发震荡波让你清醒了过来!"))
...
/obj/projectile/moon_parade/on_hit(atom/target, blocked = 0, pierce_hit)
	...
	if(!(victim in mobs_hit))
		...
		victim.balloon_alert(victim, "你感觉自己无法离开游行队伍!")
		mobs_hit += victim

	victim.add_mood_event("月之疯狂", /datum/mood_event/moon_insanity)

...
/proc/spawn_pirates(datum/comm_message/threat, datum/pirate_gang/chosen_gang)
	...
	var/list/candidates = SSpolling.poll_ghost_candidates("你想成为[span_notice("[chosen_gang.name]的海盗吗?")]", check_jobban = ROLE_TRAITOR, alert_pic = /obj/item/claymore/cutlass, role_name_text = "pirate crew")

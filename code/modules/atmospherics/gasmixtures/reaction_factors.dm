...
/datum/gas_reaction/miaster/init_factors()
	factor = list(
		/datum/gas/miasma = "Miasma-瘴气 is sterilized at a rate that scales with the difference between the temperature and [MIASTER_STERILIZATION_TEMP]K.",
		/datum/gas/oxygen = "One mole of oxygen is released per mole of miasma-瘴气 consumed.",
		"Temperature" = "Higher temperature increases the speed of miasma-瘴气 sterilization.",
		"Energy" = "[MIASTER_STERILIZATION_ENERGY] joules of energy is released per mole of miasma-瘴气 sterilized.",
	)
...
/datum/gas_reaction/plasmafire/init_factors()
	factor = list(
		...
		/datum/gas/tritium = "Tritium-氚 is formed at 1 mole per mole of plasma consumed if there are at least 97 times more oxygen than plasma.",
		/datum/gas/water_vapor = "Water vapor is formed at 0.25 moles per mole of plasma consumed if tritium isn't being formed.",
		/datum/gas/carbon_dioxide = "Carbon Dioxide-二氧化碳 is formed at 0.75 moles per mole of plasma consumed if tritium isn't being formed.",
...
/datum/gas_reaction/h2fire/init_factors()
	factor = list(
		/datum/gas/oxygen = "Oxygen is consumed at 0.5 moles per mole of hydrogen-氢气 consumed. Higher oxygen concentration up to [HYDROGEN_OXYGEN_FULLBURN] times the hydrogen increases the hydrogen consumption rate.",
		/datum/gas/hydrogen = "Hydrogen-氢气 is consumed rapidly fast as long as there's enough oxygen to allow combustion.",
		/datum/gas/water_vapor = "Water vapor is produced at 1 mole per mole of hydrogen-氢气 combusted.",
		"Temperature" = "Minimum temperature of [FIRE_MINIMUM_TEMPERATURE_TO_EXIST] kelvin to occur",
		"Energy" = "[FIRE_HYDROGEN_ENERGY_RELEASED] joules of energy is released per mol of hydrogen-氢气 consumed.",
	)
...
/datum/gas_reaction/tritfire/init_factors()
	factor = list(
		...
		/datum/gas/tritium = "Tritium-氚 is consumed at rapidly fast as long as there's enough oxygen to allow combustion.",
...
/datum/gas_reaction/freonfire/init_factors()
	factor = list(
		...
		/datum/gas/freon = "Freon-氟利昂 is consumed at a rate that scales with the distance of the temperature from [FREON_MAXIMUM_BURN_TEMPERATURE]K. Its relationship with oxygen also determines consumption rate.",
		/datum/gas/carbon_dioxide = "Carbon Dioxide-二氧化碳 is formed at 1 mole per mole of freon consumed.",
...
/datum/gas_reaction/nitrousformation/init_factors()
	factor = list(
		...
		/datum/gas/nitrogen = " 20 moles of Nitrogen-氮气 needs to be present for the reaction to occur. Nitrogen-氮气 is consumed at 1 mole per mole of nitrous oxife formed.",
...
/datum/gas_reaction/nitrous_decomp/init_factors()
	factor = list(
		/datum/gas/nitrous_oxide = "Nitrous Oxide-一氧化二氮 is decomposed at a rate that scales negatively with the distance between the temperature and average of the minimum and maximum temperature of the reaction. Minimum of [MINIMUM_MOLE_COUNT * 2] to occur.", //okay this one isn't made into a define yet.
		/datum/gas/oxygen = "Oxygen is formed at 0.5 moles per mole of nitrous oxide decomposed.",
		/datum/gas/nitrogen = "Nitrogen-氮气 is formed at 1 mole per mole of nitrous oxide decomposed.",
...
/datum/gas_reaction/bzformation/init_factors()
	factor = list(
		...
		/datum/gas/nitrous_oxide = "Each mole of bz made consumes 0.4 moles of Nitrous oxide. If there is less nitrous oxide than plasma the reaction rate is slowed down. At three times the amount of plasma to Nitrous oxide it will start breaking down into Nitrogen-氮气 and Oxygen, the lower the ratio the more Nitrous oxide decomposes.",
		...
		/datum/gas/nitrogen = "Each mole Nitrous oxide decomposed makes 1 mol Nitrogen-氮气. Lower ratio of Nitrous oxide to Plasma means a higher ratio of decomposition to BZ production.",
...
/datum/gas_reaction/pluox_formation/init_factors()
	factor = list(
		...
		/datum/gas/tritium = "Tritium-氚 is converted into hydrogen-氢气 at 0.01 moles per mole of pluoxium formed.",
		/datum/gas/pluoxium = "Pluoxium-钷 is produced at a constant rate in any given mixture.",
		/datum/gas/hydrogen = "Hydrogen-氢气 is formed from the tritium losing their neutrons.",
...
/datum/gas_reaction/nitrium_formation/init_factors()
	factor = list(
		...
		/datum/gas/tritium = "20 moles of tritium needs to be present for the reaction to occur. Tritium-氚 is consumed at 1 mole per mole of nitroum formed.",
		/datum/gas/nitrogen = "10 moles of nitrogen needs to be present for the reaction to occur. Nitrogen-氮气 is consumed at 1 mole per mole of nitrium formed.",
		/datum/gas/nitrium = "Nitrium-亚硝基兴奋气体 is produced at a rate that scales with the temperature.",
...
/datum/gas_reaction/nitrium_decomposition/init_factors()
	factor = list(
		...
		/datum/gas/nitrium = "Nitrium-亚硝基兴奋气体 is consumed at a rate that scales with the temperature.",
		/datum/gas/hydrogen = "Hydrogen-氢气 is produced at 1 mole per mole of nitrium decomposed.",
		/datum/gas/nitrogen = "Nitrogen-氮气 is produced at 1 mole per mole of nitrium decomposed.",
...
/datum/gas_reaction/freonformation/init_factors()
	factor = list(
		...
		/datum/gas/freon = "Freon-氟利昂 is produced at a rate that scales with the sum of a quadratic exponential and sigmoidal function, with the quadratic exponential peaking at 800 Kelvin, but the sigmoidal function takes dominance at over 5,500K being up to 3 times more efficient.",
...
/datum/gas_reaction/nobliumformation/init_factors()
	factor = list(
		/datum/gas/nitrogen = "10 moles of nitrogen needs to be present for the reaction to occur. Nitrogen-氮气 is consumed at 10 moles per mole of hypernoblium formed.",
		/datum/gas/tritium = "5 moles of tritium needs to be present for the reaction to occur. Tritium-氚 is consumed at 5 moles per mole of hypernoblium formed. The relative consumption rate of tritium decreases in the exposure of BZ.",
...
/datum/gas_reaction/halon_o2removal/init_factors()
	factor = list(
		/datum/gas/halon = "Halon-哈龙 is consumed at a rate that scales with temperature.",
...
/datum/gas_reaction/healium_formation/init_factors()
	factor = list(
		/datum/gas/bz = "BZ is consumed at 1/12th of a mole per mole of healium-疗气 formed.",
		/datum/gas/freon = "Freon-氟利昂 is consumed at 11/12th of a mole per mole of healium-疗气 formed.",
		/datum/gas/healium = "Healium-疗气 is formed at a rate that scales with the temperature.",
		"Temperature" = "Can only occur between [HEALIUM_FORMATION_MIN_TEMP] - [HEALIUM_FORMATION_MAX_TEMP]. Higher temperature increases healium-疗气 formation rate.",
		"Energy" = "[HEALIUM_FORMATION_ENERGY/3] joules of energy is released per mole of healium-疗气 formed.",
	)
...
/datum/gas_reaction/zauker_formation/init_factors()
	factor = list(
		...
		/datum/gas/nitrium = "Nitrium-亚硝基兴奋气体 is consumed at 1 mole per mole of zauker formed.",
		/datum/gas/zauker = "Zauker-扎克 is produced at a rate that scales with the temperature.",
		"Temperature" = "Can only occur between [ZAUKER_FORMATION_MIN_TEMPERATURE] - [ZAUKER_FORMATION_MAX_TEMPERATURE] kelvin. Zauker-扎克 formation rate is proportional to the temperature.",
...
/datum/gas_reaction/zauker_decomp/init_factors() //Fixed reaction rate
	factor = list(
		/datum/gas/zauker = "Zauker-扎克 is consumed at [ZAUKER_DECOMPOSITION_MAX_RATE SECONDS / SSair.wait] moles per second in any unique gas mixture.",
		/datum/gas/nitrogen = "At least [MINIMUM_MOLE_COUNT] moles of Nitrogen-氮气 needs to be present for this reaction to occur. Nitrogen-氮气 is produced at 0.7 moles per mole of Zauker-扎克 decomposed.",
...
/datum/gas_reaction/proto_nitrate_formation/init_factors()
	factor = list(
		/datum/gas/pluoxium = "Pluoxium-钷 is consumed at 1/11th of a mole per mole of proto-nitrate formed.",
		/datum/gas/hydrogen = "Hydrogen-氢气 is consumed at 10/11th of a mole per mole of proto-nitrate formed.",
		/datum/gas/proto_nitrate = "Proto-Nitrate-原硝酸 is produced at a rate that scales with the temperature.",
...
/datum/gas_reaction/proto_nitrate_hydrogen_response/init_factors() // Fixed reaction rate
	factor = list(
		/datum/gas/hydrogen = "[PN_HYDROGEN_CONVERSION_THRESHOLD] moles of hydrogen-氢气 needs to be present for the reaction to occur. Hydrogen-氢气 is consumed at 2 moles per mole of proto-nitrate formed.",
...
/datum/gas_reaction/proto_nitrate_tritium_response/init_factors()
	factor = list(
		/datum/gas/tritium = "Tritium-氚 radiates its neutrons at a rate that scales with the temperature and proto-nitrate mole count.",
		/datum/gas/proto_nitrate = "Proto nitrate is consumed at 0.005 moles per mole of neutrons released.",
		/datum/gas/hydrogen = "Hydrogen-氢气 remains after the neutrons escape.",
...
/datum/gas_reaction/proto_nitrate_bz_response/init_factors()
	factor = list(
		...
		/datum/gas/nitrogen = "Nitrogen-氮气 is produced at 0.4 moles per mole of BZ decomposed.",
		/datum/gas/helium = "Helium-氦 is produced at 1.6 moles per mole of BZ decomposed.",

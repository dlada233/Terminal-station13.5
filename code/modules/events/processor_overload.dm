...
/datum/round_event/processor_overload/announce(fake)
	var/alert = pick("外逸层气泡进入，可能会出现处理器过载，请联系你*%xp25)`6cq-BZZT",
		"外逸层气泡进入，可能会出现处理器过*1eta;c5;'1v¬-BZZZT",
		"外逸层气泡进入，可能会出#MCi46:5.;@63-BZZZZT",
		"外逸层气'Fz\\k55_@-BZZZZZT",
		"外逸i:%£ QCbyj^j</.3-BZZZZZZT",
		"!!hy%;f3l7e,<$^-BZZZZZZZT",
	)

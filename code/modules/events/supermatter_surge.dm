...
/datum/round_event_control/supermatter_surge
	name = "Supermatter Surge-超物质浪涌"
	typepath = /datum/round_event/supermatter_surge
	category = EVENT_CATEGORY_ENGINEERING
	weight = 15
	max_occurrences = 1
	earliest_start = 20 MINUTES
	description = "超物质能量和热量将随机增加，并受到广播"
...
/datum/round_event/supermatter_surge/announce(fake)
	priority_announce("晶体完整性监测系统检测到超物质室内异常的大气特性，能量输出显著的增加了，需要进行工程干预来稳定引擎系统.", " [surge_class]级超物质浪涌警报", 'sound/machines/engine_alert3.ogg')
...
/datum/round_event/supermatter_surge/end()
	...
	priority_announce("超物质浪涌已经消散，晶体输出读数恢复正常.", "异常解除")
	engine = null
	sm_gas = null

/datum/round_event_control/supermatter_surge/poly
	name = "Supermatter Surge: Poly's Revenge-超物质浪涌（poly的复仇）"
	typepath = /datum/round_event/supermatter_surge/poly
	category = EVENT_CATEGORY_ENGINEERING
	weight = 0
	max_occurrences = 0
	description = "当poly被推进超物质的时候. 手动运行不是很有用."
...
/datum/round_event/supermatter_surge/poly/announce(fake)
	priority_announce("晶体完整性监测系统在超物质室中检测到不寻常的鹦鹉型共振现象，能量输出显著的增加了，需要进行工程干预来稳定引擎系统.", " P级超物质浪涌警报", 'sound/machines/engine_alert3.ogg')

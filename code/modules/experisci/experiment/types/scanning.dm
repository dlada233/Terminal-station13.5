...
/datum/experiment/scanning
	...
	performance_hint = "Perform scanning experiments using a handheld experi-scanner, or the stationary 实验性破坏扫描仪. \
						Destructive scans can only be performed with the 实验性破坏扫描仪."

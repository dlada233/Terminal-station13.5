...
/datum/chemical_reaction/food/grape_vinegar
	...
	required_catalysts = list(/datum/reagent/consumable/enzyme = 5)
	mix_message = "这混杂的气味让你回想你是如何失去进入乡村俱乐部的机会的"

...
/datum/armament_entry/assault_operatives/implants/deathrattle
	name = "'死者之息'植入物套装-Deathrattle Implant Kit"
	description = "一组植入物套装（包含一个可重复使用的植入器），应植入到团队成员体内.当团队中某人死亡时，其他植入物持有者都会收到一条精神信息，告知他们队友的名字和死亡地点.与大多数植入物不同，这些植入物被设计成可植入任何生物或机械生物体内."
...
/datum/armament_entry/assault_operatives/implants/microbomb
	...
	description = "植入体内的微型炸弹.可通过手动激活或死亡时自动引爆.警告：将永久性摧毁你的身体和携带的物品."
...
/datum/armament_entry/assault_operatives/implants/thermal
	name = "热成像视觉植入物-Thermal Vision Implant"
...
/datum/armament_entry/assault_operatives/implants/nodrop
	...
	description = "这个脑部电子植入物能够让你的手部肌肉强制收缩，以防止物品从手中掉落.."
